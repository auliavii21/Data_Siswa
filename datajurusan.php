  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
      ...
      <div class="card">
          ...
          <div class="card-body">
            <table id="tabelJurusan" class="display">
                  <thead>
                      <tr>
                         <th>Kode Jurusan</th>
                         <th>Nama Jurusan</th>
        ...
        <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit_kodejurusan.php?kodejurusan=<?php echo $x['kodejurusan']; ?>&aksi=edit" class="btn btn-warning btn-sm">Edit</a>
                            <a href="proses.php?kodejurusan=<?php echo $x['kodejurusan']; ?>&aksi=hapus" class="btn btn-danger btn-sm">Hapus</a>
                            </td>
                        </td>
                    </tr>
                <?php
