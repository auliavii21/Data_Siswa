  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
      ...
      <div class="card">
          ...
          <div class="card-body">
            <table id="tabelAgama" class="display">
                  <thead>
                      <tr>
                         <th>Id Agama</th>
                         <th>Nama Agama</th>
        ...
        <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit_agama.php?idagama=<?php echo $x['idagama']; ?>&aksi=edit" class="btn btn-warning btn-sm">Edit</a>
                            <a href="proses.php?idagama=<?php echo $x['idagama']; ?>&aksi=hapus" class="btn btn-danger btn-sm">Hapus</a>
                            </td>
                        </td>
                    </tr>
                <?php
